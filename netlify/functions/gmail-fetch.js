// Gmail — Primary tab only (CATEGORY_PERSONAL)
export const handler = async (event, context) => {
  ...
  try {
    ...
    // Primary tab = INBOX + CATEGORY_PERSONAL
    const listRes = await fetch(
      'https://gmail.googleapis.com/gmail/v1/users/me/messages?maxResults=10&labelIds=INBOX&labelIds=CATEGORY_PERSONAL',
      { headers: auth }
    )
